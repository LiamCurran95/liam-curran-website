	...
	return (
		<div className="about">
			<p>
				...
				<br></br> I noticed that the bits of the work I found most engaging were
				using technological tools to enhance and improve my workflow; I have
				always had an interest in computers and programming in general and have
				dabbled with a Raspberry Pi to emulate classic games (don't tell
				Nintendo), built computers for myself, friends and family, and just
				generally enjoy tinkering and problem solving, so I decided to have a
				career change! <br></br>
