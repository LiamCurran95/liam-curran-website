	...
	return (
		<section className="mx-auto w-full max-w-6xl space-y-8 py-10">
			<div className="rounded-3xl border border-border bg-card/80 p-6 shadow-sm sm:p-10">
				<p className="text-sm uppercase tracking-[0.3em] text-body/60">Featured Work</p>
				...
				<p className="mt-4 text-base leading-relaxed text-body/80">
					This list is powered by the GitHub API and surfaces my starred repositories.
					Bookmark it to see what I’m experimenting with next.
				</p>
			</div>
