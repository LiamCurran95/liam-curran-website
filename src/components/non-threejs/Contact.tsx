export const Contact = () => {
  return (
    <section className="flex flex-col items-center gap-4 rounded-3xl border border-border bg-card/90 p-6 text-center shadow-sm sm:p-10">
      <h2 className="font-display text-3xl uppercase tracking-[0.2em] text-body">
        Contact
      </h2>
      <p className="text-base leading-relaxed text-body/80">
        Let’s talk about opportunities, collaborations, or the latest three.js
        tricks. LinkedIn is the best place to reach me.
      </p>
      <a
